...
- `cli-editor.vsix`: the CLI Editor extension, which connects VS Code terminal input to the chat-style composer and provides smart text/image paste and prompt-navigation bindings.
