...
$signer = Join-Path $artifacts 'release-tools\sign_release_ai.exe'
...
$requiredBundleFiles = @(
    'cli-editor.exe', 'codex-enhanced.exe', 'codex-code-mode-host.exe',
    'compatibility-manifest.json', 'compatibility-manifest.sig',
    'LICENSE', 'NOTICE', 'THIRD_PARTY_NOTICES_ai.md',
    'THIRD_PARTY_LICENSES_CLI_EDITOR_ai.html', 'THIRD_PARTY_LICENSES_CODEX_ai.html'
)
