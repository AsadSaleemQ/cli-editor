...
Only the newest published Codex CLI Editor release is supported. Compatibility with Codex and VS Code is narrower than binary support and is declared by the signed compatibility manifest.
